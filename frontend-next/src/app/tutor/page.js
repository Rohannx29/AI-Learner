    ...
    <main className="flex flex-col h-screen bg-[#0f172a] text-white">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6 space-y-4">
        ...
        {messages.map((msg, index) => (
          <div
            key={index}
            className={`max-w-xl px-4 py-3 rounded-2xl text-sm whitespace-pre-wrap transition-all ${
              msg.role === "user"
      ...
      <div className="p-4 border-t border-[#1e293b] bg-[#020617]/60 backdrop-blur-xl">
        <div className="flex gap-3 bg-[#020617] border border-[#334155] rounded-2xl px-4 py-2 focus-within:ring-2 focus-within:ring-purple-500 transition-all">
